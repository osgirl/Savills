...
import { View, PixelRatio, Dimensions, Platform, StyleSheet, TextInput, Image } from 'react-native';
      ...
      <View
        style={[
          Styles.inputView,
          {
            ...
            ...this.props.style,
            width: width - Resolution.scale(80),
      ...
      >
        ...
        <View style={{ position: 'absolute', left: Resolution.scale(30) }}>
          <Image
            ...
            style={{ width: Resolution.scaleWidth(15), height: Resolution.scaleHeight(15) }}
            resizeMode={'contain'}
          />
        </View>
      </View>
