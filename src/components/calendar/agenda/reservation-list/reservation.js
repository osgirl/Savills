    ...
    if (date) {
      ...
      return (
        <View style={this.styles.day}>
          <Text allowFontScaling={false} style={[this.styles.dayNum, today, {fontWeight: 'bold'}]}>{date.getDate()}</Text>
          <Text allowFontScaling={false} style={[this.styles.dayNum, today, {fontWeight: 'bold'}]}>{' / ' + month}</Text>
        </View>
      );
    } else {
      return (
