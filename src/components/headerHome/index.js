    ...
    return (
      ...
      >
        <View style={style.wrapper}>
          <Animated.View style={Opacity}>{this.props.renderViewLeft}</Animated.View>
          ...
          <View>{this.props.center ? this.props.center : <View />}</View>
          <View>
            {this.props.rightIcon || this.props.text ? (
              <View style={{ flexDirection: 'row' }}>
                {this.props.rightIconL ? (
                  <ButtonCustom
                    background={this.props.headercolor}
                    haveMargin={false}
                    onPress={this.props.rightActionL || null}
                    icon={this.props.rightIconL}
                  />
                ) : null}
                <View>
                  <ButtonCustom
                  ...
                  {this.props.notiCount && this.props.notiCount > 10 ? (
                    <View style={{ position: 'absolute', right: Resolution.scale(10), top: Resolution.scale(10) }}>
                      <View
                        style={{ backgroundColor: '#FF361A', borderRadius: 33, justifyContent: 'center', alignItems: 'center' }}
                      >
                        <View style={{ alignItems: 'center', alignSelf: 'center', justifyContent: 'center' }}>
                          <Text
                            style={{
                              color: '#FFFFFF',
                              fontSize: Resolution.scale(9),
                              fontFamily: 'OpenSans-Bold',
                              alignSelf: 'center',
                              textAlign: 'center',
                              paddingHorizontal: Resolution.scale(3),
                    ...
                    <View style={{ position: 'absolute', right: Resolution.scale(10), top: Resolution.scale(10) }}>
                      <View
                        style={{
                          ...
                          width: Resolution.scale(18),
                          height: Resolution.scale(18),
                          borderRadius: 33,
