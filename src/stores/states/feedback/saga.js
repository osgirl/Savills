...
function* getListFeedbackCompleted(action) {
  try {
    let response = yield call(API.request, action.payload);
    yield put({ ...action, type: Types.GET_LIST_FEEDBACK_COMPLETED_SUCCESS, response });
  } catch (e) {
    console.log(e)
  }
}
...
export default function* saga() {
  ...
  yield takeLatest(Types.GET_LIST_FEEDBACK_COMPLETED, getListFeedbackCompleted);
