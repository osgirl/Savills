...
class modalSuccessOrder extends Component {
  ...
  render() {
    ...
    // const idReceip = this.props.fee.orderDetail.result.feeIncoming ?
    //   this.props.fee.orderDetail.result.feeIncoming.id : 0;
    return (
          ...
          </Button>
          {
            this.state.loading ?
              ...
              <View style={{ alignItems: 'center', }}>
                ...
                <Text style={{ marginVertical: 10, color: '#505E75', fontSize: 13, fontFamily: 'OpenSans-Bold' }}>Done</Text>
                <Text style={{ marginBottom: 20, color: '#BABFC8', fontFamily: 'OpenSans-Regular', textAlign: 'center' }}>
                  {message}
                </Text>
                <Button style={{ width: width - 80, marginHorizontal: 20, height: 50 }} onPress={() => this.props.goDetail(this.state.idReceip)}>
                  <LinearGradient
                  ...
                  >
                    <Text style={{ fontSize: 15, color: '#FFFFFF', fontFamily: 'Opensans-SemiBold' }}>Detail order</Text>
                  </LinearGradient>
                </Button>
              </View>
          }
