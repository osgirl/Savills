...
import { StyleSheet, Text, View, Animated, Dimensions, Image, FlatList, Platform, ScrollView, ActivityIndicator } from 'react-native';
                                                ...
                                                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                                                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                                        <View style={{ width: width - 165 }}>
                                                            <Text numberOfLines={2} style={{ fontSize: 12, color: '#343D4D', fontFamily: 'OpenSans-SemiBold' }}>{data.feeDetail.description}</Text>
